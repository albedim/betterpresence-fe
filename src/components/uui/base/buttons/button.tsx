    ...
    colors: {
        ...
        discord: {
            root: [
                ...
                "bg-[#5865F2] text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-[#4752C4] data-loading:bg-[#4752C4]",
        ...
        "discord-outline": {
            root: [
                ...
                "text-[#5865F2]", 
                "bg-transparent shadow-xs-skeumorphic ring-1 ring-[#5865F2] ring-inset",
                
                // HOVER/LOADING STATE: Reverse Colors (Solid BG, White Text/Icons)
                "hover:bg-[#5865F2] hover:text-white data-loading:bg-[#5865F2]",
                
                // Hover Transition: Use a dark color for the ring on hover to ensure contrast
                "hover:ring-transparent", 
                
                // Disabled styles
                "disabled:shadow-xs disabled:ring-disabled_subtle disabled:text-fg-disabled",
                
                // Icon styles (Base State: Discord Blue)
                "*:data-icon:text-[#5865F2]",
                
                // Icon styles (Hover State: White)
                "hover:*:data-icon:text-white", 
                "disabled:*:data-icon:text-fg-disabled_subtle",
            ].join(" "),
        },
        "empty": {
        ...
        // 2. Caution Outline (#c97200)
        "caution": {
            root: [
                // Background: Caution Orange, Text: White
                "bg-[#c97200] text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-[#a96000] data-loading:bg-[#a96000]",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Disabled styles
                "disabled:bg-disabled disabled:shadow-xs disabled:ring-disabled_subtle",
